...
public class MyModelChicken extends ModelBase
{
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
    {
        ...
        this.rightWing.rotateAngleZ = -1.0F * MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
        this.leftWing.rotateAngleZ = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
    }
}
