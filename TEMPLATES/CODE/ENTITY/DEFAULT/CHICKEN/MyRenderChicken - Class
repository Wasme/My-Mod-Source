...
public class MyRenderChicken extends RenderLiving
{
    private static final ResourceLocation chickenTextures = new ResourceLocation("mymod:textures/entity/MyChicken.png");

    public MyRenderChicken(ModelBase par1ModelBase, float par2)
    {
        super(par1ModelBase, par2);
    }

    public void renderChicken(MyEntityChicken par1EntityChicken, double par2, double par4, double par6, float par8, float par9)
    {
...
*/
    ...
    {
        this.renderChicken((MyEntityChicken)par1EntityLiving, par2, par4, par6, par8, par9);
    }
...
*/
    ...
    {
        this.renderChicken((MyEntityChicken)par1Entity, par2, par4, par6, par8, par9);
    }
}
