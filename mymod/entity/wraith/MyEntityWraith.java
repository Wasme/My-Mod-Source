...
public class MyEntityWraith extends EntityMob
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(0.96D);
    }
    ...
    {
        this.playSound("mob.spider.step", 0.0F, 0.0F);
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(Item.coal.itemID, 5);
        }
    }
